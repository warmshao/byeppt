...
export const strings = {
  ...
  de: {
    ...
    setKeyAdd: 'Schlüssel hinzufügen',
    setKeyUpdate: 'Schlüssel aktualisieren',
    setKeyTest: 'Testen',
  ...
  pt: {
    ...
    setDefaultModel: 'Modelo padrão',
    setKeyConfigured: 'Configurado',
    setKeyMissing: 'Não configurado',
    setKeyPlaceholder: 'Colar chave de API…',
    setKeyAdd: 'Adicionar chave',
    setKeyUpdate: 'Atualizar chave',
    setKeyTest: 'Testar',
  ...
  pl: {
    ...
    setKeyAdd: 'Dodaj klucz',
    setKeyUpdate: 'Aktualizuj klucz',
    setKeyTest: 'Testuj',
  ...
  ms: {
    ...
    setDefaultModel: 'Model lalai',
    setKeyConfigured: 'Dikonfigurasi',
    setKeyMissing: 'Belum dikonfigurasi',
    setKeyPlaceholder: 'Tampal kunci API…',
    setKeyAdd: 'Tambah kunci',
    setKeyUpdate: 'Kemas kini kunci',
    setKeyTest: 'Uji',
  ...
  'zh-TW': {
    ...
    settings: '設定',
    setSecGeneral: '一般',
    setSecProviders: '模型供應商',
    setSecImageGen: '圖片生成',
    setDefaultModel: '預設模型',
